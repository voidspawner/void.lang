class VOIDlang {
	...
	companion object {
	  ...
	  // expression
		...
		fun expression_minus() {
		}

		fun expression_multiply() {
		}

		fun expression_divide() {
		}

		fun expression_modulo() {
		}

		fun expression_power() {
		}
		...
		fun expression_notequal() {
		}

		fun expression_greater() {
		}

		fun expression_less() {
		}

		fun expression_greater_equal() {
		}

		fun expression_less_equal() {
		}

		fun expression_in() {
		}

		fun expression_notin() {
		}

		fun expression_is() {
		}

		fun expression_isnot() {
		}

		fun expression_assign() {
		}

		fun expression_plus_assign() {
		}

		fun expression_assign_plus() {
		}

		fun expression_minus_assign() {
		}

		fun expression_assign_minus() {
		}

		fun expression_multiply_assign() {
		}

		fun expression_divide_assign() {
		}

		fun expression_modulo_assign() {
		}

		fun expression_power_assign() {
		}

		fun expression_shr_assign() {
		}

		fun expression_shl_assign() {
		}
