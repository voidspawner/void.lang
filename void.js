class VOIDlang {
  ...
  // expression
	...
	static expression_plus() {
	}

	static expression_minus() {
	}

	static expression_multiply() {
	}

	static expression_divide() {
	}

	static expression_modulo() {
	}

	static expression_power() {
	}

	static expression_shr() {
	}

	static expression_shl() {
	}

	static expression_notequal() {
	}

	static expression_greater() {
	}

	static expression_less() {
	}

	static expression_greater_equal() {
	}

	static expression_less_equal() {
	}

	static expression_in() {
	}

	static expression_notin() {
	}

	static expression_is() {
	}

	static expression_isnot() {
	}

	static expression_assign() {
	}

	static expression_plus_assign() {
	}

	static expression_assign_plus() {
	}

	static expression_minus_assign() {
	}

	static expression_assign_minus() {
	}

	static expression_multiply_assign() {
	}

	static expression_divide_assign() {
	}

	static expression_modulo_assign() {
	}

	static expression_power_assign() {
	}

	static expression_shr_assign() {
	}

	static expression_shl_assign() {
	}
  ...
  // control
	...
	static control_break() {
	}

	static control_continue() {
	}

	static control_repeat() {
	}

	static control_return() {
	}
  ...
  // crypto
	...
	static barcode_encode() {
	}

	static barcode_decode() {
	}
...
const isMainNode = isNode && import.meta.url === `file://${process.argv[1]}`;
if (isMainNode) {
	VOIDlang.run();
}
